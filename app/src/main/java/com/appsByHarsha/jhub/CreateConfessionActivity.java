    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        confess_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(confession_txt.getText().toString().length()<10){
                    Toast.makeText(CreateConfessionActivity.this, "length should be more than 10 letters", Toast.LENGTH_SHORT).show();
                }
