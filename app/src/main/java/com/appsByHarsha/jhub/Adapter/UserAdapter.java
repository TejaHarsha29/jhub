...
import com.appsByHarsha.jhub.Model.BffsModel;
import com.appsByHarsha.jhub.Model.CrushModel;
import com.appsByHarsha.jhub.Model.NotificationModel;
import com.appsByHarsha.jhub.Model.StarsModel;
import com.appsByHarsha.jhub.ProfileActivity;
...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.viewHolder> {
    ...
    private void nrStars(String userid,TextView textView,String folder,String typee,UserModel user){
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference().child("Users").child(userid).child(folder);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(typee.equals("stars")){


                    FirebaseDatabase.getInstance().getReference().child("Users").child(user.getUser_id()).child("follower_count").setValue(snapshot.getChildrenCount());
                }
                else if(typee.equals("bffs")){
                    FirebaseDatabase.getInstance().getReference().child("Users").child(user.getUser_id()).child("bffCount").setValue(snapshot.getChildrenCount());

                }
                else{
                    FirebaseDatabase.getInstance().getReference().child("Users").child(user.getUser_id()).child("crush_count").setValue(snapshot.getChildrenCount());
