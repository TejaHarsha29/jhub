...
import com.appsByHarsha.jhub.CommentActivity;
import com.appsByHarsha.jhub.LikesActivity;
                        ...
                        switch (item.getItemId()) {
                            ...
                            case R.id.delete:
                                ...
                                if(FirebaseAuth.getInstance().getCurrentUser().getUid().equals(model.getPostedBy())){
                                    FirebaseDatabase.getInstance().getReference().child("Posts").child(model.getPost_id()).removeValue();
                                    ...
                                    Toast.makeText(context, "Not the Owner of post", Toast.LENGTH_SHORT).show();
                                    return true;
